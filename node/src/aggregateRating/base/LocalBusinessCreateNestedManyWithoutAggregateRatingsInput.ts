...
@InputType()
class LocalBusinessCreateNestedManyWithoutAggregateRatingsInput {
...
export { LocalBusinessCreateNestedManyWithoutAggregateRatingsInput as LocalBusinessCreateNestedManyWithoutAggregateRatingsInput };
