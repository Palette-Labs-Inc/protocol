...
@InputType()
class LocalBusinessUpdateManyWithoutAggregateRatingsInput {
...
export { LocalBusinessUpdateManyWithoutAggregateRatingsInput as LocalBusinessUpdateManyWithoutAggregateRatingsInput };
