...
@InputType()
class LocalBusinessCreateNestedManyWithoutOrganizationsInput {
...
export { LocalBusinessCreateNestedManyWithoutOrganizationsInput as LocalBusinessCreateNestedManyWithoutOrganizationsInput };
