...
const CREATE_INPUT = {
  ...
  price: 42.42,
  priceCurrency: "examplePriceCurrency",
  quantity: 42,
...
describe("MenuItem", () => {
  ...
  test("POST /menuItems", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        createAt: CREATE_RESULT.createAt.toISOString(),
  ...
  test("GET /menuItems", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          createAt: FIND_MANY_RESULT[0].createAt.toISOString(),
  ...
  test("GET /menuItems/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        createAt: FIND_ONE_RESULT.createAt.toISOString(),
