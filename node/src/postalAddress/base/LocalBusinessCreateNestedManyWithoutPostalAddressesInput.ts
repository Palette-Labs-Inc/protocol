...
@InputType()
class LocalBusinessCreateNestedManyWithoutPostalAddressesInput {
...
export { LocalBusinessCreateNestedManyWithoutPostalAddressesInput as LocalBusinessCreateNestedManyWithoutPostalAddressesInput };
