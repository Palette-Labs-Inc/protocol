...
@InputType()
class LocalBusinessCreateNestedManyWithoutBazaarsInput {
...
export { LocalBusinessCreateNestedManyWithoutBazaarsInput as LocalBusinessCreateNestedManyWithoutBazaarsInput };
