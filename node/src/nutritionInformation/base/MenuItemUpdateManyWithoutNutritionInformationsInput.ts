...
@InputType()
class MenuItemUpdateManyWithoutNutritionInformationsInput {
...
export { MenuItemUpdateManyWithoutNutritionInformationsInput as MenuItemUpdateManyWithoutNutritionInformationsInput };
